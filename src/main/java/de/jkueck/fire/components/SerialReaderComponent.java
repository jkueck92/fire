...
public class SerialReaderComponent {
    ...
    public SerialReaderComponent(ApplicationEventPublisher applicationEventPublisher, ISettingService settingService) {
    ...
    public void listen() {
        ...
        String comPort = this.settingService.getStringValue(SettingNames.SETTING_COM_PORT);
        if (StringUtils.isNotBlank(comPort)) {
            ...
            log.warn("can not start serial listing, comPort is missing in settings");
        }
